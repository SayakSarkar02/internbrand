...
const Subbar = ({type, handleSetType}) => {

    const selected = " bg-purple-dark text-white "
  return (
    <div className="my-8 flex flex-row ">
        ...
        <div className="w-2/3">
            ...
            <div className="flex w-[90%] flex-row rounded-xl border-[1px] border-black/10">
                <input type="text" className="grow rounded-l-xl outline-2 -outline-offset-1 outline-purple-dark px-5" />
